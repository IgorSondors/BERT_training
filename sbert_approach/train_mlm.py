...
pth_tokenizer = "/mnt/vdb1/Datasets/my_tokenizer2"
# Load the model
model = AutoModelForMaskedLM.from_pretrained(model_name)
tokenizer = AutoTokenizer.from_pretrained(pth_tokenizer)#(model_name)
...
fld = "/mnt/vdb1/BERT_training/sbert_approach/mlm_weights/experiment_part_of_word_masking/18_categories_my_tokenizer2"
